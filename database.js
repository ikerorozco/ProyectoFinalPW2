...
if (!localStorage.getItem("productos")) {
    ...
    const productosIniciales = [
        { id: 1, nombre: "Laptop HP", precio: 8500, vendedor: "Juan Perez", Descripcion: "Potente y elegante laptop con procesador de última generación, pantalla Full HD, almacenamiento rápido SSD y batería de larga duración", Stock: 40},
        { id: 2, nombre: "Teléfono Xiaomi", precio: 3500, vendedor: "Maria Lopez", Descripcion: "Smartphone moderno con cámara de alta resolución, batería de larga duración, pantalla AMOLED vibrante y rendimiento rápido", Stock: 37 },
        { id: 3, nombre: "Cámara Digital Canon", precio: 2500, vendedor: "Carlos Gomez", Descripcion: "Cámara profesional con sensor de alta resolución, enfoque rápido, estabilización avanzada y conectividad inalámbrica", Stock: 7 },
        { id: 4, nombre: "Silla Gaming", precio: 1500, vendedor: "Ana Fernandez", Descripcion: "Silla gamer ergonómica con diseño premium, cojines ajustables, reclinación de 180°, reposabrazos 4D y materiales duraderos", Stock: 11 },
